...
This project makes use of the supplied API. This means that the bowling_algorithm.py file will not function without the API 
running in the specified location, but the test_bowling.py will still function.
